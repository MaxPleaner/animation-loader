...
(function() {
  var asset_dir, build_frames_ranges, compile_video, exec_sync, fs, gen_path, gen_tmp_png_path, get_num_frames, loader_utils, querystring_parser, randomstring, to_merged, to_resized, to_transparent_gif, to_webm_alpha;
  ...
  to_merged = function(arg) {
    ...
    if (![bg_path, fg_path].every(fs.existsSync)) {
